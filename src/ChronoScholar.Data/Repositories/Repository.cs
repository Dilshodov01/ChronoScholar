...
using ChronoScholar.Domain.Configurations.DBPath;
...
namespace ChronoScholar.Data.Repositories;
...
public class Repository<TEntity> : IRepository<TEntity> where TEntity : Auditable
{
    ...
    public Repository()
    {
        ...
        else if (typeof(Seller) == typeof(TEntity))
        {
            this.Path = DatabasePath.SellerDb;
        }
        else if (typeof(Textbook) == typeof(TEntity))
        {
            this.Path = DatabasePath.TextbookDb;
        }
